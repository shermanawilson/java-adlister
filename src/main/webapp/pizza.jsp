...
<form method="POST" action="/pizza-order">
    ...
    <form class="form-inline">
        <label class="my-1 mr-2" for="crust">Select the Crust Type:</label>
        <select class="custom-select my-1 mr-sm-2" id="crust" name="crust">
        ...
        <form class="form-inline">
            <label class="my-1 mr-2" for="sauce">Select the Sauce Type:</label>
            <select class="custom-select my-1 mr-sm-2" id="sauce" name="sauce">
                <option selected>Choose...</option>
            ...
            <%--     SIZE   --%>
            <label class="mr-sm-2" for="size">Select the Pizza size:</label>
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="pepperoni" name="pepperoni" value="pepporoni">
                <label class="form-check-label" for="pepperoni">Pepperoni</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="cheese" name="cheese" value="cheese">
                <label class="form-check-label" for="cheese">Cheese</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="mushrooms" name="mushrooms" value="mushrooms">
                <label class="form-check-label" for="mushrooms">Mushrooms</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="checkbox" id="onions" name="onions" value="onions">
            ...
            <div class="container" name="address">
                <div class="row">
                    <form class="form-horizontal" name="address">
                        <fieldset>
                            <!-- Address form -->
